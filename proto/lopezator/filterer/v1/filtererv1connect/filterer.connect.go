...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/lopezator/filterer/lopezator/filterer/v1"
	http "net/http"
	strings "strings"
)
...
var (
	filtererServiceServiceDescriptor      = v1.File_lopezator_filterer_v1_filterer_proto.Services().ByName("FiltererService")
